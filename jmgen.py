def generate(path, name, frameNumber, frameRate, width, height):
    ...
    '''
    file.write(cfg4)
    file.write('TraceFile             = "trace_' + name + '.txt"      # Trace file\n')
    file.write('    ReconFile             = "recon_' + name + '.yuv"       # Reconstruction YUV file\n')
    file.write('    OutputFile            = "' + path + name + '.264' + '"           # Bitstream\n    ')
    file.write('StatsFile             = "stats_' + name +'.dat"          # Coding statistics file')
    cfg5 = '''
    ...
    SearchRange           = 0   # Max search range
    ...
    DisableIntra4x4        = 1  # Disable Intra 4x4 modes
    ...
    file.write('InitialQP               = 0    # Initial Quantization Parameter for the first I frame\n')
